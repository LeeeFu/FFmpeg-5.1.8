...
/* 添加调用约定属性支持 - 针对 NDK r26 的 Android ARM ABI 兼容性 */
#if defined(__ANDROID__) && defined(__arm__) && !defined(__aarch64__)
    /* ARM 32-bit (armeabi-v7a) 需要使用 aapcs-vfp 调用约定 */
    #define VK_CALLBACK_ATTR __attribute__((pcs("aapcs-vfp")))
#else
    /* 其他架构使用默认约定 */
    #define VK_CALLBACK_ATTR
#endif
...
static VkBool32 VKAPI_CALL VK_CALLBACK_ATTR vk_dbg_callback(VkDebugUtilsMessageSeverityFlagBitsEXT severity,
